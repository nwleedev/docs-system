...
Templates do not require a worked-example input file, Next.js, a specific item count, or a specific source list. If an explicit concern list exists, preserve source items; otherwise derive targets from stack evidence and official documentation.
