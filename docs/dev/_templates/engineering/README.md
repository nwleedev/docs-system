...
Confirm the target repository's `docs/dev/engineering/README.md` Include, Exclude, and Dynamic File Policy. Do not assume this repository's React, TypeScript, TanStack Query, Tailwind, Orval, or repository-specific Rust/WASM guidance applies to another repository without target evidence.
