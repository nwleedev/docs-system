...
`skills/use-words-review/SKILL.md`의 검토 시점, 모델 선택과 재검토 조건을 보완한다.
...
### 스킬 README의 내용을 배포 문서로 옮긴다

`skills/use-words-review/README.md`를 삭제하기 전에 그 파일의 현재 책임을 다음과 같이 나눈다.
...
내용을 옮기고 내부 링크를 바꾼 뒤 `skills/use-words-review/README.md`를 삭제한다. 주석 범위를 자동으로 넣고 지우는 코드나 생성기는 만들지 않는다.
...
- **변경한다.** `skills/use-words-review/SKILL.md`, `skills/use-words-review/references/examples.md`, `AGENTS.md`, `src/AGENTS.en.md`, `src/AGENTS.ko.md`, `README.md`, `README.ko.md`.
