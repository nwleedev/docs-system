...
| V3 | R2, R4-R6, R8-R9, U3 | `rg -n "React|TypeScript|TanStack|Tailwind|Orval|Rust|project-specific-library|Zustand|React Hook Form|Next|Vue|Angular|Svelte" docs/dev/README.md docs/dev/_templates` plus manual review. | Named stacks appear only as optional examples or not at all; no template requires them. |
