...
| --- | --- | --- | --- |
| R1-R3 | `requirements.md`, untracked input reconstruction | Full | C00-C48 present. |
...
| R25-R30 | `research/0004-portable-source-pack-workflow.md`, `requirements.md`, `plan.md` | Full | Proposed portable target decomposition workflow recorded without making Next.js, a worked-example input file, or item count the baseline. |
...
| R48-R51 | `docs/dev/README.md`, `docs/dev/_templates/README.md`, `docs/dev/_templates/repository/_template.md`, `docs/dev/_templates/_bootstrap-audit.md`, `docs/dev/_commands/**` | Full | Portable target decomposition and non-normative command runbooks are implemented without making Next.js, a worked-example input file, source lists, or fixed item counts baselines. |
