...
| E2 | `requirements.md#Concern Inventory` review | Worked example target inventory | C00-C48 are reconstructed as worked-example targets. | The input filename and item count are not portable docs/dev baselines. |
