...
- **관계를 분명히 한 문장:** 검수자는 검토 결과가 문서에 반영됐는지 확인한다. 승인 책임자가 배포 범위를 승인하면 배포 담당자가 배포를 시작한다.
...
- **관계를 분명히 한 문장:** 검수자가 변경된 안내 문구를 확인한 뒤 승인된 문구를 화면에 반영한다.
...
- **관계를 분명히 한 문장:** 검수자가 변경 내용을 확인한다. 승인 책임자는 검수 결과를 검토한 뒤 배포 여부를 결정한다.
...
- **관계를 분명히 한 문장:** 담당자가 변경된 항목을 목록으로 만든다. 승인 책임자가 목록에서 배포할 항목을 정하면 배포 담당자는 승인된 항목만 배포한다.
...
- **관계를 분명히 한 문장:** 검수 결과와 배포 기록을 첨부한 보고서는 일주일 동안 보관한다.
...
- **관계를 분명히 한 문장:** 검토자는 경고를 먼저 표시하는 방안을 제안했다. 승인 책임자가 이 방안을 승인하면 작업자는 경고를 표시한 뒤 작업을 계속한다.
