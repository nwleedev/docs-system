...
- If the current run cannot find or read the skill or `references/korean.md` in full, do not claim completion of work that requires the review. Report whether the observed gap is a missing installation or a missing reference, to the extent that the current run can determine it.
